...
\begin{table}[htbp]
	...
	\caption{
		...
		shape index generally matches or outperforms the Type Index, except for templates D6, D7, and S4: D6 and D7 perform ~1\% worse, while S4 reaches 100\% with T-LDP versus only 6\% with the shape index.
		}
