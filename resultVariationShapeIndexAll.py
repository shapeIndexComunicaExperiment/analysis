...
fig.text(0.5, 0.0, "Query Template", ha='center', va='center', fontsize=fontSize)
fig.text(0.0, 0.5, yaxisLabel, ha='center', va='center', rotation='vertical', fontsize=fontSize)
